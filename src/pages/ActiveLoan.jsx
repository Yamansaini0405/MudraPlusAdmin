...
export default function ActiveLoan() {
  ...
  const fetchLoans = async () => {
    try {
      setLoading(true);
      setError(null);
      const data = await loanApi.getActiveLoans();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">All Active Loans</h1>
          <p className="text-gray-600 mt-1">Manage and track all active loan applications</p>
        </div>
      </div>
